...
<body>
	...
	<div>
		...
		<div class="palantir">
    		<a href="http://www.palantir.com" target="_blank" style="background: #fff; display: inline-block; padding: 11px 11px 5px;"><img src="img/sponsors/palantir.png"  height="36" /></a>
		</div>
		<div class="microsoft">
			<a href="http://www.microsoft.com/en-sg/default.aspx" target="_blank" style="background: #fff; display: inline-block; padding: 5px 8px 0;"><img src="img/sponsors/microsoft.png"  height="47" /></a>
		</div>
	</div>
	</section>
	<nav>
